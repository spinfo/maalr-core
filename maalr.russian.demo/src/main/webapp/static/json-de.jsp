...
<h1>Die Suche mit "Maalr! словарь" auf einer Webseite einbetten</h1>

<h2>iFrame</h2>

<p>Die einfachste Möglichkeit, auf Ihrer Webseite die Suche im "Maalr! словарь" zu ermöglichen, besteht
...
<div class="well" style="width:350px;">
	<iframe src="<%=Configuration.getInstance().getServerInetAddress()%>/iframe.html" seamless="true" width="350px" height="350px"></iframe>
</div>
...
<textarea rows="8" style="width:100%;">
 ...
 &lt;div id=&quot;maalr_query_div&quot; class=&quot;maalr_query_div&quot;
    		...
    		&lt;script type=&quot;text/javascript&quot; src=&quot;<%=Configuration.getInstance().getServerInetAddress()%>/assets/js/maalr_embedded.js&quot;&gt;&lt;/script&gt;
 &lt;/div&gt;
...
<table>
	...
	<tr>
		...
		<td>nein</td>
		<td>-</td>
		<td>Gibt an, in welcher Sprache das Formular dargestellt werden soll. Entweder "de" oder "ru".</td>
	</tr>
	<tr>
		<td>data-button</td>
		<td>ja</td>
